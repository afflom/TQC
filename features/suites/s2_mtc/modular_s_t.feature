...
Feature: Modular S/T matrices
  Constructed as the quantum double D(Z_n) (n = context) — an anomaly-free pointed modular
  ...
  group-law fusion. (status: build; never asserted to be the unique Atlas category.)
