...
|---|---|---|---|---|---|
| `f1-atlas` | F1 — UOR Atlas (Lean 4, machine-checked, sorry-free) | commit `d4b5f51` / `v0.0.1`, lean `v4.16.0` | MIT | `oracles/f1/atlas-constants.json` (sha256 `0b7c4952…`) | sha256 + CI re-derivation diff (`xtask atlas-extract`) |
